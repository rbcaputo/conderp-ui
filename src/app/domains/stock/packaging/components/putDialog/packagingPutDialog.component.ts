...
@Component({
  ...
  templateUrl: "./packagingPutDialog.component.html",
  styleUrl: "../../../../../common/scss/putDialog.style.scss"
})
export class PackagingPutDialogComponent implements OnInit {
  // Properties.
  ...
  public updatePackagingByPublicIdAsync(packagingPublicId: string): void {
