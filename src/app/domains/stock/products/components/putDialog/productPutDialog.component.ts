...
@Component({
  ...
  templateUrl: "./productPutDialog.component.html",
  styleUrl: "../../../../../common/scss/putDialog.style.scss"
})
export class ProductPutDialogComponent implements OnInit {
  // Properties.
  ...
  public updateProductByPublicIdAsync(productPublicId: string): void {
