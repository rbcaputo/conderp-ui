...
import { USER_TYPE_OPTS } from "../../../../../resources/types/userTypes.enum";
...
@Component({
  ...
  templateUrl: "./userPostDialog.component.html",
...
export class UserPostDialogComponent implements OnInit {
  ...
  public addUserAsync(): void {
    this.postForm.markAllAsTouched();

    if (this.postForm.valid) {
      this._userService.addUserAsync(this.postForm.value)
        .pipe(takeUntil(this._destroy$))
        .subscribe({
