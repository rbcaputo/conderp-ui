...
@Component({
  selector: "supplier-delete-dialog",
  imports: [
    MatDialogModule,
    MatButtonModule
  ],
  templateUrl: "./supplierDeleteDialog.component.html",
...
export class SupplierDeleteDialogComponent {
  ...
  // Methods.
  public deleteSupplierByPublicIdAsync(supplierPublicId: string): void {
    this._supplierService.deleteSupplierByPublicIdAsync(supplierPublicId)
