...
@Component({
  ...
  templateUrl: "./customerPutDialog.component.html",
  styleUrl: "../../../../../common/scss/putDialog.style.scss"
})
export class CustomerPutDialogComponent implements OnInit {
  // Properties.
  ...
  public updateCustomerByPublicIdAsync(customerPublicId: string): void {
