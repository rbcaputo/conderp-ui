...
@Component({
  ...
  templateUrl: "./customerPostDialog.component.html",
  styleUrl: "../../../../../common/scss/postDialog.style.scss"
})
export class CustomerPostDialogComponent implements OnInit {
  // Properties.
  ...
  public addCustomerAsync(): void {
    this.postForm.markAllAsTouched();

    if (this.postForm.valid) {
      this._customerService.addCustomerAsync(this.postForm.value)
        .pipe(takeUntil(this._destroy$))
        .subscribe({
