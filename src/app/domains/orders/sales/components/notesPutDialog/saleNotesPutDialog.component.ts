...
@Component({
  selector: "sale-notes-put-dialog",
  imports: [
    MatDialogModule,
    ReactiveFormsModule,
    MatFormFieldModule,
  ...
  templateUrl: "./saleNotesPutDialog.component.html",
  styleUrl: "../../../../../common/scss/notesPutDialog.style.scss"
})
export class SaleNotesPutDialogComponent implements OnInit {
  // Properties.
  ...
  public upsateSaleNotesByPublicIdAsync(salePublicId: string) {
