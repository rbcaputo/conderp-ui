...
@Component({
  selector: "production-get-dialog",
  imports: [
    CommonModule,
    MatDialogModule,
    MatButtonModule,
  ...
  templateUrl: "./productionGetDialog.component.html",
  styleUrl: "../../../../../common/scss/getDialog.style.scss"
})
export class ProductionGetDialogComponent {
  // Properties.
  ...
  public get isDisabled(): boolean {
    return this.production.status === OrderStatus.Delivered || this.production.status === OrderStatus.Canceled;
  }
}
