...
@Component({
  selector: "production-notes-put-dialog",
  imports: [
    MatDialogModule,
    ReactiveFormsModule,
    MatFormFieldModule,
  ...
  templateUrl: "./productionNotesPutDialog.component.html",
  styleUrl: "../../../../../common/scss/notesPutDialog.style.scss"
})
export class ProductionNotesPutDialogComponent implements OnInit {
  // Properties.
  ...
  public updateProductionNotesByPublicIdAsync(productionPublicId: string): void {
